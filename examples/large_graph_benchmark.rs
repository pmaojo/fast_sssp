...
fn run_benchmark(vertices: usize, edges: usize) {
    println!(
        "\n📊 Benchmark with {} vertices and {} edges:",
    ...
    let results_match = fast_result
        .distances
        .iter()
        .zip(dijkstra_result.distances.iter())
        .all(|(a, b)| match (a, b) {
...
fn run_sparse_benchmark(vertices: usize, edges: usize) {
    println!(
        "\n📊 Sparse Graph Benchmark with {} vertices and {} edges:",
        vertices.to_string().yellow(),
        edges.to_string().yellow()
    );
    ...
    println!(
        "✅ Sparse graph generated with {} vertices and {} edges",
        vertices,
        graph.edge_count()
    );
...
fn run_grid_benchmark(size: usize) {
    println!(
        "\n📊 Grid Graph Benchmark with {}x{} grid:",
    ...
    println!(
        "✅ Grid graph generated with {} vertices and {} edges",
        vertices, edge_count
    );
